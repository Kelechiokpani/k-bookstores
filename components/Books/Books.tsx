"use client"; // Make sure this is here so Next.js treats this as a client component
...
export default function BooksPage() {
    ...
    // Filter products based on params and search query
    const filteredProducts = useMemo(() => {
        ...
        return filtered;
    }, [categoryParam, sortParam, minParam, maxParam, searchQuery]);
    ...
    return (
        ...
        >
            ...
            >
                <h3 className="text-lg font-medium mb-2">Search Books</h3>
                <Input
                    type="search"
